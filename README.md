...
- Tampilan marker titik dan heatmap
- Laporan warga secara real-time / simulasi laporan masuk
- Panel verifikasi laporan dengan status:
  - Menunggu
  - Proses
  - Selesai
- Statistik laporan harian
- Data laporan per kecamatan
- Modal detail laporan kecamatan
- Daftar laporan netizen
- Notifikasi toast untuk laporan baru
- Desain responsif untuk desktop dan mobile
- Visual dashboard yang ringkas dan mudah dibaca

## Manfaat
- Memudahkan membaca data secara visual
- Mempercepat pemetaan lokasi laporan
- Mengurangi ketergantungan pada data teks yang panjang
- Membantu melihat pola masalah secara cepat
- Lebih efisien untuk monitoring dan pengambilan keputusan
